...
public class ModCreativeModeTabs {
	public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB = DeferredRegister
			.create(Registries.CREATIVE_MODE_TAB, SFMFlow.MODID);

	public static final Supplier<CreativeModeTab> SFMFLOW_ITEMS_TAB = CREATIVE_MODE_TAB.register("sfmflow_items_tab",
			() -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.MANAGER_BLOCK.get()))
					...
					.displayItems((itemDisplayParameters, output) -> {
						...
						output.accept(ModItems.PROGRAM_DISK.get());
					}).build());
