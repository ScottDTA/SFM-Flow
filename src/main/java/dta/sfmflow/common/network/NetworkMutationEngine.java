...
/**
 * Handles fast graph mutation validations without triggering slow world rescans
 * [3].
 */
public class NetworkMutationEngine {
	...
	/**
	 * Performs an in-memory primitive micro-BFS to check if a redundant connection
	 * path remains [3]. Avoids reading physical world blocks, keeping the check
	 * completely CPU/RAM-bound [3].
	 *
