...
/**
 * Registry manager managing the instantiation and binding of blocks and block items [3].
 */
public class ModBlocks
 {
  ...
  public static final DeferredBlock<Block> OBSERVER_CABLE_BLOCK = registerBlock("observer_cable_block",
                                                                         () -> new ObserverCableBlock(BlockBehaviour.Properties.of()
                                                                                                               .strength(2.0F, 5.0F)
                                                                                                               .sound(SoundType.METAL)
                                                                                                               .requiresCorrectToolForDrops()
                                                                                                               .pushReaction(PushReaction.BLOCK)));
  ...
  public static final DeferredBlock<Block> ITEM_EJECTOR_HATCH_BLOCK = registerBlock("item_ejector_hatch_block",
          () -> new ItemEjectorHatchBlock(BlockBehaviour.Properties.of()
                                                .strength(2.0F, 5.0F)
                                                .sound(SoundType.METAL)
                                                .requiresCorrectToolForDrops()
                                                .pushReaction(PushReaction.BLOCK)));
  ...
  public static final DeferredBlock<Block> ITEM_VACUUM_HATCH_BLOCK = registerBlock("item_vacuum_hatch_block",
          () -> new ItemVacuumHatchBlock(BlockBehaviour.Properties.of()
                                                .strength(2.0F, 5.0F)
                                                .sound(SoundType.METAL)
                                                .requiresCorrectToolForDrops()
                                                .pushReaction(PushReaction.BLOCK)));
  ...
  public static final DeferredBlock<Block> FLUID_HATCH_CABLE_BLOCK = registerBlock("fluid_hatch_cable_block",
                                                                         () -> new FluidHatchCableBlock(BlockBehaviour.Properties.of()
                                                                                                               .strength(2.0F, 5.0F)
                                                                                                               .sound(SoundType.METAL)
                                                                                                               .requiresCorrectToolForDrops()
                                                                                                               .pushReaction(PushReaction.BLOCK)));
  ...
  public static final DeferredBlock<Block> CABLE_CLUSTER_BLOCK = registerBlock("cable_cluster_block",
                                                                         () -> new CableClusterBlock(BlockBehaviour.Properties.of()
                                                                                                               .strength(2.0F, 5.0F)
                                                                                                               .sound(SoundType.METAL)
                                                                                                               .requiresCorrectToolForDrops()
                                                                                                               .pushReaction(PushReaction.BLOCK)));

  public static final DeferredBlock<Block> ADVANCED_CABLE_CLUSTER_BLOCK = registerBlock("advanced_cable_cluster_block",
                                                                         () -> new CableClusterBlock(BlockBehaviour.Properties.of()
                                                                                                               .strength(2.0F, 5.0F)
                                                                                                               .sound(SoundType.METAL)
                                                                                                               .requiresCorrectToolForDrops()
