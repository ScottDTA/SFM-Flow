...
/**
 * Directional network monitor extending vanilla ObserverBlock to reuse positioning and tick logic [3].
 * Overrides getSignal to remain electrically silent to vanilla redstone, functioning purely as a network target [3].
 */
public class ObserverCableBlock extends ObserverBlock {
    ...
    /**
     * Overrides the parent codec lookup to match vanilla's invariance requirements [3].
     * Uses double-casting to safely bypass Java's generic invariance compiler checks [3].
     *
