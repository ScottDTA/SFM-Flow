...
public final class ModTags {
	 ...
	 * redstone/network targets [3]. Allows addon developers to register custom
	 * redstone, sensor, and signal cables cleanly [3].
	 */
	 ...
	 * Cable Clusters [3]. Excludes cluster blocks programmatically to avoid
	 * infinite capability recursive loops [3].
	 */
