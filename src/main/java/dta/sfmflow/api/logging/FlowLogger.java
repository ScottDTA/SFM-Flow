...
/**
 * Utility logger class offering garbage-free diagnostics for pathfinding sweeps [3].
 */
public final class FlowLogger
 {
  ...
  /**
   * Logs pathfinding diagnostics under active debug configurations [3].
   * Resolves standard printf-style string formatting safely before SLF4J handoff [3].
   *
