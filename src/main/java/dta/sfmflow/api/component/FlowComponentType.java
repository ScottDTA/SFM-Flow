 ...
 * component types [3]. Houses registration handlers and manages instantiation
 * logic for flowchart nodes [3].
 */
public class FlowComponentType {
	...
	/**
	 * Registered supplier holder for the specialized INTERVAL_TRIGGER component
	 * type [3].
	 */
	public static final DeferredHolder<FlowComponentType, FlowComponentType> INTERVAL_TRIGGER = FlowComponentBuilder
			...
			.codec(IntervalTriggerComponent.CODEC).build(COMPONENT_TYPES);

	/**
	 * Registered supplier holder for the specialized ITEM_INPUT component type [3].
	 * Consolidated: points to the unified ItemTransferComponent parameterized as an
	 * input node [3].
	 */
	public static final DeferredHolder<FlowComponentType, FlowComponentType> ITEM_INPUT = FlowComponentBuilder
			...
			.codec(ItemTransferComponent.INPUT_CODEC).build(COMPONENT_TYPES);

	/**
	 * Registered supplier holder for the specialized ITEM_OUTPUT component type
	 * [3]. Consolidated: points to the unified ItemTransferComponent parameterized
	 * as an output node [3].
	 */
	public static final DeferredHolder<FlowComponentType, FlowComponentType> ITEM_OUTPUT = FlowComponentBuilder
			...
			.codec(ItemTransferComponent.OUTPUT_CODEC).build(COMPONENT_TYPES);
