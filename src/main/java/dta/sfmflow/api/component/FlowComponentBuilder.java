...
/**
 * Fluent API builder streamlining the registration of custom flowchart component types [3].
 */
public class FlowComponentBuilder
 {
  ...
  /**
   * Configures the relative icon texture asset path for client-side rendering [3].
   *
