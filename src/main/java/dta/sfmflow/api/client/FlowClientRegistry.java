...
/**
 * Public client-only registry managing the visual and descriptive mappings for
 * flowchart nodes [3]. Maps registered component types to their custom UI
 * presentation properties [3].
 */
@OnlyIn(Dist.CLIENT)
public class FlowClientRegistry {
	...
	/**
	 * Registers custom client presentation properties for a specific
	 * FlowComponentType [3].
	 *
	...
	/**
	 * Retrieves the custom client presentation properties registered for a specific
	 * FlowComponentType [3].
	 *
