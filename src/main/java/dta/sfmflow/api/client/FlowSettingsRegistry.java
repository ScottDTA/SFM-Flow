...
/**
 * Client-only registry managing the registration of custom UI settings panels
 * to flowchart node types [3]. Provides a clean interface for developers to
 * link interactive configurations without dedicated server physical loading
 * [3].
 */
@OnlyIn(Dist.CLIENT)
public class FlowSettingsRegistry {
	...
	/**
	 * Registers a custom settings widget provider for a specific FlowComponentType
	 * [3].
	 *
	...
	/**
	 * Retrieves the custom settings widget provider registered for a specific
	 * FlowComponentType [3].
	 *
