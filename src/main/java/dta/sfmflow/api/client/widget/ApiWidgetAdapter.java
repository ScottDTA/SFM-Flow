...
/**
 * Public client-only API widget adapter representing a wrapper for vanilla Minecraft UI controls [3].
 * Synchronizes visible/active states, delegates coordinate modifications,
 * and routes input focus, clicks, drags, releases, and keys directly to the wrapped vanilla component [3].
 *
...
public class ApiWidgetAdapter<T extends AbstractWidget> extends AbstractFlowWidget
 {
  ...
  public ApiWidgetAdapter(T vanillaWidget)
   {
    super(vanillaWidget.getX(), vanillaWidget.getY(), vanillaWidget.getWidth(), vanillaWidget.getHeight(), vanillaWidget.getMessage());
  ...
  /**
   * Defensive bounds verification added to prevent scroll conflicts between stacked components [3].
   */
  @Override
  ...
  private static class TintedGuiGraphics extends GuiGraphics
   {
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, @javax.annotation.Nullable String text, int x, int y, int color)
     {
      suspendTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, @javax.annotation.Nullable String text, int x, int y, int color, boolean dropShadow)
     {
      suspendTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, @javax.annotation.Nullable String text, float x, float y, int color, boolean dropShadow)
     {
      suspendTint();
      int res = super.drawString(font, text, x, y, color, dropShadow);
      resumeTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, net.minecraft.util.FormattedCharSequence text, int x, int y, int color)
     {
      suspendTint();
      int res = super.drawString(font, text, x, y, color);
      resumeTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, net.minecraft.util.FormattedCharSequence text, int x, int y, int color, boolean dropShadow)
     {
      suspendTint();
      int res = super.drawString(font, text, x, y, color, dropShadow);
      resumeTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, net.minecraft.util.FormattedCharSequence text, float x, float y, int color, boolean dropShadow)
     {
      suspendTint();
      int res = super.drawString(font, text, x, y, color, dropShadow);
      resumeTint();
    ...
    @Override
    public int drawString(net.minecraft.client.gui.Font font, Component text, int x, int y, int color, boolean dropShadow)
     {
      suspendTint();
      int res = super.drawString(font, text, x, y, color, dropShadow);
      resumeTint();
