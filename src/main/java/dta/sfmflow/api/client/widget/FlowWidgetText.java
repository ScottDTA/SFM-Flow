 ...
 * automated ellipsis shortening, optional horizontal alignment centering, and dynamic colors [3].
 */
public class FlowWidgetText extends AbstractFlowWidget
 ...
 public FlowWidgetText(Font fontRenderer, int x, int y, int width, int height, Component message, float scale, boolean centered)
  {
   ...
   */
  public FlowWidgetText(Font fontRenderer, int x, int y, int width, int height, Component message, float scale, boolean centered, Supplier<Integer> colorSupplier)
   {
