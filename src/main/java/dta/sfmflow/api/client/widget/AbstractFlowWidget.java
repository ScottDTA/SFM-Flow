...
/**
 * Public API client-only base class representing a custom visual flowchart element [3].
 * Implements ContainerEventHandler to support vanilla recursive hit checks and input forwarding [3].
 */
@OnlyIn(Dist.CLIENT)
public abstract class AbstractFlowWidget extends AbstractWidget implements ContainerEventHandler
 {
  ...
  public void playDownSound(SoundManager handler) 
   {
	// Default empty implementation allowing customized click sound playback configurations
   }
