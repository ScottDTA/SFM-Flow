...
/**
 * Public clientbound API event posted on the {@code NeoForge.EVENT_BUS} when a
 * node's dropdown configuration menu is being constructed [3]. Allows
 * third-party integration add-ons to dynamically register custom text links
 * [3].
 */
public class RegisterDropdownLinksEvent extends Event {
	 ...
	 *
	 * @param component the logical flowchart component being targeted by the
	 *                  dropdown [3]
	 */
	...
	/**
	 * Registers a new custom text link option to append to the active dropdown menu
	 * [3].
	 *
	 * @param label         the display chat Component title [3]
	 * @param onClickAction the execution callback run when the link is left-clicked
	 *                      [3]
	 */
	...
	/**
	 * Data record pairing a localized display label to an executable action
	 * callback [3].
	 *
