...
public class SlotLayoutProvider implements DataProvider {
	...
	/**
	 * Populates the layout map. Can be overridden by subclasses to register custom
	 * layouts [3].
	 */
	protected void buildLayouts() {
		// Furnace layout mimicking vanilla furnace UI (indices: 0 = Input, 1 = Fuel, 2
		// = Output)
		layouts.put(ResourceLocation.withDefaultNamespace("furnace"),
				new SlotLayout(
						...
						176, 98, List.of(new SlotEntry(0, 56, 17), // Input Slot
		...
		layouts.put(ResourceLocation.withDefaultNamespace("blast_furnace"),
				new SlotLayout(
						ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID,
								"textures/gui/slot_layouts/furnace.png"),
						176, 98,
						List.of(new SlotEntry(0, 56, 17), new SlotEntry(1, 56, 53), new SlotEntry(2, 115, 34))));

		// Smoker layout
		layouts.put(ResourceLocation.withDefaultNamespace("smoker"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/furnace.png"), 176, 98,
				List.of(new SlotEntry(0, 56, 17), new SlotEntry(1, 56, 53), new SlotEntry(2, 115, 34))));
		
		layouts.put(ResourceLocation.withDefaultNamespace("brewing_stand"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/brewing_stand.png"),
				176, 98,
				List.of(new SlotEntry(0, 55, 50),
						new SlotEntry(1, 78, 57),
						new SlotEntry(2, 101, 50),
						new SlotEntry(3, 78, 16),
						new SlotEntry(4, 16, 16))));
		
		layouts.put(ResourceLocation.withDefaultNamespace("dropper"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/dropper.png"),
				176, 98,
				List.of(new SlotEntry(0, 61, 16),
		...
		layouts.put(ResourceLocation.withDefaultNamespace("dispenser"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/dropper.png"),
				176, 98,
				List.of(new SlotEntry(0, 61, 16),
						new SlotEntry(1, 79, 16),
						...
						new SlotEntry(7, 79, 52),
						new SlotEntry(8, 97, 52))));
		layouts.put(ResourceLocation.withDefaultNamespace("crafter"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/crafter.png"),
				176, 98,
				List.of(new SlotEntry(0, 25, 16),
		...
		layouts.put(ResourceLocation.withDefaultNamespace("hopper"), new SlotLayout(
				ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID, "textures/gui/slot_layouts/hopper.png"),
				176, 66,
				List.of(new SlotEntry(0, 43, 19),
