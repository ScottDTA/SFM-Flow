...
public class ModBlockTagProvider extends BlockTagsProvider {
	...
	protected void addTags(Provider provider) {
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.MANAGER_BLOCK.get(), ModBlocks.CABLE_BLOCK.get(),
				...
				ModBlocks.CABLE_CLUSTER_BLOCK.get(), ModBlocks.SIGN_UPDATER_CABLE_BLOCK.get(),
				ModBlocks.ENERGY_RELAY_BLOCK.get(), ModBlocks.ITEM_RELAY_BLOCK.get(), ModBlocks.FLUID_RELAY_BLOCK.get(),
		...
		tag(ModTags.CABLES).add(ModBlocks.CABLE_BLOCK.get(), ModBlocks.HARDENED_CABLE_BLOCK.get(),
				...
				ModBlocks.SCULK_TRIGGER_CABLE_BLOCK.get(), ModBlocks.SIGN_UPDATER_CABLE_BLOCK.get(),
				ModBlocks.ENERGY_RELAY_BLOCK.get(), ModBlocks.FLUID_RELAY_BLOCK.get(), ModBlocks.ITEM_RELAY_BLOCK.get(),
				ModBlocks.ADVANCED_CABLE_CLUSTER_BLOCK.get());
