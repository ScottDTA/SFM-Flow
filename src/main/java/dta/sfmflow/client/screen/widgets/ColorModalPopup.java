...
/**
 * Symmetrical color selection overlay displaying Minecraft's 16 base colors in
 * an 8x2 grid [3]. Employs responsive border-outline highlights to indicate
 * active and hovered options [3].
 */
@OnlyIn(Dist.CLIENT)
public class ColorModalPopup extends AbstractModalPopup {
	...
	protected void renderComponent(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
		...
		// backdrops [3]
		guiGraphics.drawString(parentScreen.getFont(), Component.literal("Node Color"), getX() + 5, getY() + 4,
				0xFF404040, false);
		...
		for (int i = 0; i < 8; i++) {
			...
			// 🔥 Added responsive hover outlines: Selected -> White, Hovered -> Gold,
			// Default -> Black [3]
