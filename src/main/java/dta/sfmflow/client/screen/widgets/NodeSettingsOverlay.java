 ...
 * Intercepts inputs and delegates them selectively to active focused child targets [3].
 */
@OnlyIn(Dist.CLIENT)
public abstract class NodeSettingsOverlay extends AbstractFlowWidget {
    ...
    /**
     * Isolates dragging actions exclusively to the active focused/clicked child [3].
     */
    @Override
