...
/**
 * Concrete settings overlay mapped specifically to configure Interval Trigger execution periods [3].
 * Configured with standard, uncolored widgets and silent slider actions [3].
 */
@OnlyIn(Dist.CLIENT)
public class IntervalTriggerSettingsOverlay extends NodeSettingsOverlay {
    /**
     * Instantiates stacked unit cycles and speed control sliders inside the modal overlay [3].
     *
    ...
    private static class IntervalSlider extends AbstractSliderButton {
        ...
        public IntervalSlider(int x, int y, int width, int height, IntervalTriggerComponent component, NodeSettingsOverlay overlay) {
