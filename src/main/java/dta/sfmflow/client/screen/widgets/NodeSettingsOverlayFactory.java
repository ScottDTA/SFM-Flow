...
/**
 * Client-only factory managing the instantiation of custom Settings Overlays for nodes [3].
 */
@OnlyIn(Dist.CLIENT)
public final class NodeSettingsOverlayFactory {
    ...
    /**
     * Resolves the component type and returns its appropriate configuration overlay panel [3].
     *
