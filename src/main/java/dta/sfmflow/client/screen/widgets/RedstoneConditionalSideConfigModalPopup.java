...
@OnlyIn(Dist.CLIENT)
public class RedstoneConditionalSideConfigModalPopup extends AbstractModalPopup {
	private final RedstoneConditionalComponent component;
	...
	public RedstoneConditionalSideConfigModalPopup(ManagerScreen parentScreen, RedstoneConditionalComponent component, Direction side, BlockPos pos, Runnable onChanged) {
	...
	private static class ThresholdSlider extends AbstractSliderButton {
		...
		public ThresholdSlider(int x, int y, int width, int height, RedstoneConditionalComponent component, Direction side, Runnable onChanged) {
