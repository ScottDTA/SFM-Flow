...
/**
 * Parent node element widget wrapping standard compact cards and terminal pins [3].
 * Coordinates dragging bounds, layout translations, and delegates input bounds checks cleanly to visible children [3].
 */
@OnlyIn(Dist.CLIENT)
public class FlowWidgetContainer extends AbstractFlowWidget {
  ...
  /**
   * Instantiates the container and populates child node cards and pin terminals [3].
   *
  ...
  public FlowWidgetContainer(ManagerScreen parentScreen, AbstractFlowComponent component, int x, int y) {
	super(x + component.getX(), y + component.getY(), component.getVisualWidth(), component.getVisualHeight(), Component.literal("FlowWidgetContainer"));
  ...
  protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
    ...
    // Offset card rendering by +50.0F to create space below all cards for connection wires [3]
