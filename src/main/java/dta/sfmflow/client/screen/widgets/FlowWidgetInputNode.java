...
/**
 * Client-only flowchart widget representing an input execution terminal along
 * the top edge [3]. Employs standard pin textures rendered vertically flipped
 * (upside down) [3].
 */
@OnlyIn(Dist.CLIENT)
public class FlowWidgetInputNode extends AbstractFlowWidget {
	private static final ResourceLocation INPUT_NODE = ResourceLocation.fromNamespaceAndPath(SFMFlow.MODID,
	...
	protected void renderComponent(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
		...
		guiGraphics.blit(INPUT_NODE, getX(), getY(), 6, 6, 0.0F, (float) (vOffset + 6), 6, -6, 6, 12);
