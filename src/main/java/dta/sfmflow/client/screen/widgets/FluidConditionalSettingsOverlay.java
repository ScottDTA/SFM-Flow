...
/**
 * Settings overlay enabling visual configuration of Fluid Conditionals.
 */
@OnlyIn(Dist.CLIENT)
public class FluidConditionalSettingsOverlay extends AbstractFilterableTargetSettingsOverlay {
