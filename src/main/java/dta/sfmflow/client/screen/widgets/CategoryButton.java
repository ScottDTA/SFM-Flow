 ...
 * Positioned along the manager console sidebar, hovering triggers the dynamic
 * creation of its associated category hovering submenu [3].
 */
@OnlyIn(Dist.CLIENT)
public class CategoryButton extends AbstractFlowWidget {
	...
	public CategoryButton(NodeCategory category, int x, int y, ManagerScreen parentScreen) {
		...
		// Explicitly clear default hover tooltips as per the technical layout
		// specification
