...
/**
 * Client-only strategy contract for executing specific flowchart delta updates [3].
 */
@OnlyIn(Dist.CLIENT)
@FunctionalInterface
public interface IDeltaStrategy
 {
   ...
   * @param localComponent the client-side component model, or null if adding/removed [3]
   */
